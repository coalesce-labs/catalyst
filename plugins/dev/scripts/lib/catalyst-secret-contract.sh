...
_CSC_IDS=(
  ...
  "linear-heartbeat-actor" "linear-heartbeat-api-token"
  "groq-api-key" "cloud-token" "age-key"
)
_CSC_DELIVERY=(
  "bare-file" "bare-file" "bare-file-family" "env-file" "env-file" "env-alias" "config-json"
  "config-json" "config-json" "env-alias" "config-json" "platform-env" "local-only"
)
