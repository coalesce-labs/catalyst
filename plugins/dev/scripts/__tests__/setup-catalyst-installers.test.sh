...
# Covers: source guard, detect_arch, ensure_local_bin, offer_install_jq,
#         offer_install_node, offer_install_bun, offer_install_humanlayer,
#         offer_install_gh_cli, and the no-pip repo-wide regression guard.
#
