...
OUT9="$(run_check_ga "$P9" "$CD9" "$XDG9" "$BIN9")"
RC9=$?
...
XDG10="${SCRATCH}/p10-xdg"
BIN10="${SCRATCH}/p10-bin"
LOG10="${SCRATCH}/p10-curl.log"
...
XDG11="${SCRATCH}/p11-xdg"
BIN11="${SCRATCH}/p11-bin"
LOG11="${SCRATCH}/p11-curl.log"
...
XDG12="${SCRATCH}/p12-xdg"
BIN12="${SCRATCH}/p12-bin"
LOG12="${SCRATCH}/p12-curl.log"
mkdir -p "${XDG12}/catalyst"
: >"$LOG12"
...
XDG13="${SCRATCH}/p13-xdg"
BIN13="${SCRATCH}/p13-bin"
LOG13="${SCRATCH}/p13-curl.log"
mkdir -p "${XDG13}/catalyst"
: >"$LOG13"
...
XDG14="${SCRATCH}/p14-xdg"
BIN14="${SCRATCH}/p14-bin"
LOG14="${SCRATCH}/p14-curl.log"
mkdir -p "${XDG14}/catalyst"
: >"$LOG14"
...
XDG15="${SCRATCH}/p15-xdg"
BIN15="${SCRATCH}/p15-bin"
LOG15="${SCRATCH}/p15-curl.log"
mkdir -p "${XDG15}/catalyst"
: >"$LOG15"
...
XDG16="${SCRATCH}/p16-xdg"
BIN16="${SCRATCH}/p16-bin"
LOG16="${SCRATCH}/p16-curl.log"
mkdir -p "${XDG16}/catalyst"
: >"$LOG16"
...
XDG17="${SCRATCH}/p17-xdg"
BIN17="${SCRATCH}/p17-bin"
LOG17="${SCRATCH}/p17-curl.log"
mkdir -p "${XDG17}/catalyst"
: >"$LOG17"
