...
CLI_NAMES=(catalyst-broker catalyst-comms catalyst-events catalyst-filter catalyst-session catalyst-state catalyst-db catalyst-monitor catalyst-thoughts catalyst-claude)
