...
// BOARD2 / CTL-906: shadcn new-york Switch over the existing `radix-ui` umbrella
// (no new dep). Used for the boolean popover rows (Show empty columns). The
// checked treatment uses `--primary` / `--accent` tokens — never the cyan live
// signal (#5be0ff), which is reserved for liveness only.
function Switch({
  className,
  ...props
