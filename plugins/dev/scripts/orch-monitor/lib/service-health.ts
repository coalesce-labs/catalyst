...
export function buildRegistry(cfg: ServiceHealthConfig): ServiceDescriptor[] {
  ...
  return [
    ...
    },
    {
      ...
      configSource: "event-log service.name=broker (board-snapshot fallback)",
      intervalMs: REGISTRY_INTERVAL_MS,
    ...
    },
    {
      ...
      kind: "event-recency",
      target: "event-log service.name=execution-core",
      configSource: "event-log execution-core heartbeat",
      intervalMs: REGISTRY_INTERVAL_MS,
      degradedAfterMs: DAEMON_DEGRADED_MS,
      downAfterMs: DAEMON_DOWN_MS,
    },
