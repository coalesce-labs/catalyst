...
// CTL-343 / CTL-483 / CTL-529: the broker.state.json liveness file and the
// worker-state shadow projection were extracted to ./projection.mjs (imported
// above). The worker.state_changed event handler stays here with the other
// event handlers and calls projection.mjs's path + writer helpers; it moves
// to router.mjs in the next phase.
