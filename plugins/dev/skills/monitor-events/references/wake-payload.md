...
_Read this when parsing a `filter.wake.*` event from the broker and need to extract PR number, CI conclusion, review state, or other typed fields without hand-rolling jq paths._
