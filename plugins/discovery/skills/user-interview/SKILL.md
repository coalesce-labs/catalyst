...
**Tools needed:** Claude Code (primary), research repository (optional)
...
- Claude.ai (analysis)
- transcription tool free tier (transcription)
  → Total cost: $0

**$50-100/month:**

- Claude Pro ($20/month)
- transcription tool Pro ($17/month)
- Make.com ($9/month)
  → Total cost: $46/month

**$300-500/month:**

- research repository ($300+)
- Grain ($29/month)
- Claude Pro ($20/month)
