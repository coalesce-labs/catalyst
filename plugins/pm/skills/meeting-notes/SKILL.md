...
You can give me:
- Raw transcript (from Zoom, Grain, transcription tool, Google Meet)
...
- Link to design files or prototypes
...
_Next meeting:_ [Date] to discuss [Topic]
...
_→ Update stakeholder profile: Emphasize data-driven go/no-go decisions_
...
_→ Add to lessons-learned: VPs appreciate when PMs anticipate their questions_
```
