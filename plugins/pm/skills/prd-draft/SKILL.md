...
- _Engagement Impact:_ [DAU/MAU/Retention change]
- _Top-Line Impact:_ [Revenue/GMV change]
- _Bottom-Line Impact:_ [Contribution margin/profit change]
...
4. **design tool Description** - Detailed spec for designer handoff
