...
1. **Is this meeting actually necessary?** Could the outcome be achieved async (Slack thread or shared doc)?
...
- **For updates:** A written status update sent to stakeholders
