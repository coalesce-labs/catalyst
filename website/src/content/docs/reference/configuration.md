...
| `CATALYST_BH_TRIAGE_PRODUCTION` _(env var)_         | `shadow`                  | Triage-production invariant mode: `off` skips triage-artifact inspection, `shadow` publishes stalled candidates without mutating, `enforce` lets the invariant propose an escalate-only tier-3 move.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `CATALYST_BH_TRIAGE_STALL_MS`                       | `1800000` (30 min)        | Maximum age of the most recent successful triage completion before owned, untriaged eligible work with free capacity is reported as a stalled triage producer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
