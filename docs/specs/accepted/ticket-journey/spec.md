---
title: Ticket journey / execution view
status: accepted
ticket: CTL-1003
---
...
> direction, demote the relevant file with a `git mv` to `draft/`.

## Mockups

- [`governance-ticket-journey-tab.html`](./governance-ticket-journey-tab.html) — the execution/journey tab (CTL-1003).
- [`governance-track1-process-view.html`](./governance-track1-process-view.html) — the journey process view.
