...
| **D17** | `abandoned` (clean exit, no declaration — CTL-1790)             | any            | **re-dispatch the SAME phase**, generation+1. **Never advance.**                            | none                                                                                      | a fresh `<phase>.claim.<gen+1>` `O_EXCL` create                                                                                                   |
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Resolve ticket from a merge** — `github.pr.merged` carries **no ticket id**; resolve once (branch → PR title → `phase-pr.json` reverse lookup) and mint `catalyst.merge.resolved.<T>` `{ticket, pr, mergeCommitSha, repo, mergedAt}` | **merge-resolver**                                                                                                                                                                                           | `github.pr.merged` (**447 on mini in 2026-08**, carrying `vcs.pr.number` + `body.payload.mergeCommitSha`)                                    | event-id dedupe ring + an archive-scoped marker (§7a.8)                                                                                             | `merge.ticket-unresolved` — **never guess a ticket**                                                                                                                            |
...
| **`.teardown-complete` archive terminal marker** (`phase-teardown/SKILL.md:585-586`) — read by cross-host reconstruction as proof the ticket finished                                                                                  | done-writer, written **after** step 4 into `~/catalyst/archives/<T>/`                                                                                                                                        | `ticket.done.<T>`                                                                                                                            | idempotent `: >` create                                                                                                                             | `reconstruct-ticket-state.mjs:103` finding an archive dir with no marker                                                                                                        |
