...
| 2 | Done-ticket worktrees | Worktrees for Linear "Done" tickets not cleaned up interactively | `worktree-presweep.sh` stops sessions first; `git status --porcelain` must be clean; NEVER removes dirty worktrees |
